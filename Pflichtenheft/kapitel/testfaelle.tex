	...
	\begin{center}
		\begin{tabularx}{\textwidth}{ p{.05\textwidth} | p{.25\textwidth} | p{.2\textwidth} | X }
			...
			\begin{itemize}
				...
				\item[Web:] SysAdmin erhält eine Übersicht über die Organisationen.
				\item[Web:] OrgAdmin und B.m.b.R erhalten eine Übersicht der Verträge.
			\end{itemize} \\ \hline
			%%---- APP-1: Ablauf ----%%
			...
			05 & APP-1 & Der Nutzer trägt seinen Nutzernamen, sein Passwort und die gültige URL des Webservers ein. & Eine neue Verbindung zu einem Webserver wird hergestellt. \\ \hline
			06 & ACC-1 & Der OrgAdmin erstellt eine neue Rolle. & Die neue Rolle erhält Rechte für bestimmte Bereiche auf dem Webserver. \\ \hline
			07 & ACC-1 & Der OrgAdmin fügt neue Nutzer hinzu oder löscht bestehende. & Neue Nutzer werden dauerhaft Organisationen mit einer Rolle zugewiesen. Ausgewählte Nutzer werden dauerhaft aus der Organisation gelöscht. \\ \hline
		\end{tabularx}	
	\end{center}
