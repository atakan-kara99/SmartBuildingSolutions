...
\begin{longtable}[c]{|p{4cm}|p{10cm}|}
    ...
    \end{enumerate}                                                                                                                                                                                                                                 \\ \hline
    \textbf{Benutzte Anwendungsfälle}   & Change status of position (ACC-1), Diagramm: Plot construction progress, Diagram: Plot states of billing items from one contract (DIA-1)                                                                                                                                                               \\ \hline
    \textbf{Spezielle Anforderungen}    & -                                                                                                                                                                                                                    \\ \hline
    \textbf{Annahmen}                   & -                                                                                                                                                                                                                    \\ \hline
\end{longtable}