...
\begin{figure}[h]
	\centering
	\begin{tabularx}{\textwidth}{ X | X }
		\textbf{Anwendungsfall ID} & Diagramm-1 \\ \hline
...
%		\textbf{Weitere Akteure} & Organisationsadministrator, Mitarbeiter \\ \hline
		...
		%%\textbf{Ausnahme} &
		\multirow{2}{*}{\textbf{Ausnahme}} &
		\begin{enumerate} % Nutzer wählt Daten aus ohne Zugriffsrecht / während der Diagrammabfrage wurden die Rechte entfernt
	...
	\end{tabularx}
	\caption{Anwendungsfall XX-1}
	\label{fig:anwendungsfall-Diagrammerstellung-tabelle-xx-1}
