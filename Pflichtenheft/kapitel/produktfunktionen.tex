\begin{figure}[h]
	...
	\begin{tabularx}{\textwidth}{ p{.2\textwidth} | X | X }
		...
		WebServer & Hauptzugriffsstelle f\"ur alle Vetrags- und Projektrelevanten Daten. Dies ist kein menschlicher Akteur, sondern die Applikation, die die Funktionalität des Webservers bietet &  Push local changes to web server,  Authenticate\\ \hline
