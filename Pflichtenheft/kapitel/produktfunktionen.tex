...
\begin{longtable}[c]{|p{4cm}|p{10cm}|}
    ...
    \end{enumerate}                                                                                                             \\ \hline
    \textbf{Benutzte Anwendungsfälle} & Authenticate, Check role                                                                         \\ \hline
    \textbf{Spezielle Anforderungen}  & -                                                                                                  \\ \hline
    \textbf{Annahmen}                 & -                                                                                                  \\ \hline
\end{longtable}
...
\begin{longtable}[c]{|p{4cm}|p{10cm}|}
    ...
    \textbf{Anwendungsfallnamen}           & Diagram: Plot construction progress, Diagram: Plot states of billing items from one contract                   \\ \hline
    \textbf{Initiierender Akteur}          & WebUser                                                                                                         \\ \hline
    ...
    \textbf{Nachbedingungen}               & Das gewünschte Diagramm wird angezeigt                                                                                                               \\ \hline
    \textbf{Ablauf}                        &
    \begin{enumerate}
    ...
    \begin{enumerate} % Fehlende Berechtigungen für einzelne LPs.
        ...
        \item Fehlermeldung wird angezeigt!
    \end{enumerate}                                                                                                                               \\ \hline
    \textbf{Benutzte Anwendungsfälle}      & Authenticate (ACC-1)                                                                                      \\ \hline
    \textbf{Spezielle Anforderungen}       & -                                                                                                               \\ \hline
    \textbf{Annahmen}                      & -                                                                                                               \\ \hline
\end{longtable}
...
\begin{longtable}[c]{|p{4cm}|p{10cm}|}
    ...
    \end{enumerate}                                                                                                                                                                                                                                 \\ \hline
    \textbf{Benutzte Anwendungsfälle}   & Authenticate (ACC-1), Diagram: Plot construction progress, Diagram: Plot states of billing items from one contract (DIA-1)                                                                                                                                                               \\ \hline
    \textbf{Spezielle Anforderungen}    & -                                                                                                                                                                                                                    \\ \hline
    \textbf{Annahmen}                   & -                                                                                                                                                                                                                    \\ \hline
\end{longtable}