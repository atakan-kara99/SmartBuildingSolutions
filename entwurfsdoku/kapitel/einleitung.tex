...
\begin{longtable}[h]{p{4cm} p{2cm} p{8cm}}
    ...
    Bootstrap                        & neueste (5.1.0)   & \url{https://getbootstrap.com/docs/5.1/getting-started/download/}                                \\
      \rowcolor[HTML]{E7E7E7}
     Chart.js & neueste (3.5.1) & \url{https://www.jsdelivr.com/package/npm/chart.js}
\end{longtable}
\end{center}
...
\begin{longtable}[h]{p{4cm} p{2cm} p{8cm}}
    ...
    Android Studio           & neueste        & \url{https://developer.android.com/studio} \\
       Gradle & 7.0.1          & \url{https://gradle.org/releases/}                                                  \\
    \rowcolor[HTML]{E7E7E7}
   OkHttp           & 4.9.0        & \url{https://mvnrepository.com/artifact/com.squareup.okhttp3/okhttp} \\
   JUnit & ab Version 4 & \url{https://junit.org/junit4/} \\
    \rowcolor[HTML]{E7E7E7}
   Espresso-Core  & 3.4.0   & \url{https://mvnrepository.com/artifact/androidx.test.espresso/espresso-core?repo=google} \\
   CameraX & 1.0.1 & \url{https://developer.android.com/training/camerax} \\
     \rowcolor[HTML]{E7E7E7}
   Room  & 2.3.0  & \url{https://developer.android.com/jetpack/androidx/releases/room} \\
\end{longtable}
\end{center}
