...
public class DatabaseInitService {
	...
	if (userRepo.count() == 0) {
	    ...
	    Contract con1 = new Contract("Wohnzimmer bauen", "Sachen müssen erledigt werden", null, null, null, null,
		    pro2);
	    Contract con2 = new Contract("Küche installieren", null, null, null, null, null, pro2);
