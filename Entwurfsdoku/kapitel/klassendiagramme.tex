...
\begin{longtable}[h]{p{5cm} p{9cm}}
	...
	*Repository & Verwaltet die jeweilige Datenmodellklasse. Bietet spezielle Zugriffsfunktionen für eine einfachere Nutzung \\
    ...
    einzelnen DatenRepositories werden vor dem Nutzer verborgen. Alle Methoden verlangen einen Nutzernamen als Parameter, um festzustellen welche Daten tatsächlich zurückgegeben werden dürfen. Dafür werden intern die Rollen verwendet.
	...
	\rowcolor[HTML]{E7E7E7} 
	DBSynchronisationService & Dienst, welcher die Aufgabe hat nach einem Zeitintervall eine Synchronisation der Datenbank mit der von adesso zu veranlassen. Die Eigentliche Synchronisation wird
	...
	\rowcolor[HTML]{E7E7E7} 
    JSONDeserialiser & Deserialisiert JSON-Strings zu den entsprechenden Modellklassen. Dies findet Verwendung, wenn die über die REST-API von adesso Daten abgefragt werden. \\
\end{longtable}
